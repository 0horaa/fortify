...
function validateRegister(){
    ...
    if(logo.length <= 0){
        error = true;
        errorLogo.innerHTML = "";
        errorLogo.innerHTML = "Faça upload de uma foto";
    }else{
        errorLogo.innerHTML = "";
    }
    ...
    if(district.length <= 0 || district.length > 100){
        ...
        window.scroll(0,district.offsetTop - 15);
    }else{
        errorDistrict.innerHTML = "";
    }
    ...
    if(nameAcademy.length <= 0 || nameAcademy.length > 100){
        ...
        window.scroll(0,nameAcademy.offsetTop - 15);
    }else{
        errorNameAcademy.innerHTML = "";
    }
    ...
    if(description.length <= 0 || description.length > 300){
        ...
        window.scroll(0,description.offsetTop - 15);
    }else{
        errorDescription.innerHTML = "";
    }
    ...
    if(cityAcademy.length <= 0 || cityAcademy.length > 45){
        ...
        window.scroll(0,cityAcademy.offsetTop - 15);
    }else{
        errorCityAcademy.innerHTML = "";
    }
    ...
    if(addressAcademy.length <= 0 || addressAcademy.length > 100){
        ...
        window.scroll(0,addressAcademy.offsetTop - 15);
    }else{
        errorAddressAcademy.innerHTML = "";
    }
...
try{
    document.querySelector("#price").addEventListener("keypress",function(event){ //função ativada pressionando as teclas
...
try{
    document.querySelector("#cep").addEventListener("keypress",function(event){ //função ativada pressionando as teclas
        if(!verifyChar(event)){ //se o verifyChar retornar falso, significa que o usuario não digitou números
            event.preventDefault(); //logo, ele é impedido e prevenido de digitar
        }
    });

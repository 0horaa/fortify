<?php
    ...
    if(isset($_SESSION["academyEmail"]) && isset($_SESSION["academyPassword"])){
        header("Location: pages/home-academy.php");
    }
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <meta name="description" content="Faça login e aproveite agora os serviços gratuitos da Fortify! Você pode gerenciar todos os seus clientes de forma simples e prática!">
    ...
    <title>Faça login na Fortify e controle sua Academia em qualquer lugar</title>
</head>
<body class="body">
    <form method="POST" class="form-login">
        <h1 class="title-register">Login</h1>
        <label for="email" class="lbl">E-mail do responsável:</label>
        <input type="email" name="email" id="email" placeholder="Digite seu email...">
        <label for="password" class="lbl">Senha do responsável:</label>
        ...
        <a href="register_academy.php" class="link-login">Não cadastrou sua empresa?</a>
        ...
        if(isset($_POST["btn-login"])){
            ...
            try{
                ...
                if($count > 0){
                    ...
                    $_SESSION["academyEmail"] = $email;
                    $_SESSION["academyPassword"] = $password;
                    ...
                    header("Refresh: 3, pages/home-academy.php?pg=home");
                }else{
                    echo '<script>document.querySelector("#alert").style.display = "none"</script>';
